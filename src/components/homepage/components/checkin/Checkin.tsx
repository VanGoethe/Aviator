...
export const Checkin = (props: Props) => {
  ...
  const { retrieveBooking, getBookings, checkinBooking } = useStoreActions(
      ...
      <div className="col-md-12">
        <div className="search-tabs search-tabs-bg mt-5">
          ...
          <div className="card p-5">
            <p>
              Web Check-In starts 36 hours before departure and ends 2 hours
              before departure
            </p>
            ...
            <div className="mt-5">
              <h5 className="mt-3 mb-4" style={{ textDecoration: "underline" }}>
                ...
                <span style={{ fontSize: "14px", color: "gray" }}>
                  ({bookingList ? bookingList.length : 0} items)
                </span>
              </h5>
